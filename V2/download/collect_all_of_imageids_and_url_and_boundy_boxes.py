...
labels_and_imageed = (pd.read_csv(
    "./data/validation-annotations-human-imagelabels-boxable.csv").append(
        pd.read_csv("./data/train-annotations-human-imagelabels-boxable.csv")
).append(
        pd.read_csv("./data/test-annotations-human-imagelabels-boxable.csv")
).append(
        pd.read_csv("./data/oidv6-train-annotations-human-imagelabels.csv")
).append(
        pd.read_csv("./data/train-annotations-machine-imagelabels.csv")
).append(
        pd.read_csv("./data/test-annotations-machine-imagelabels.csv")).append(
            pd.read_csv(
                "./data/validation-annotations-machine-imagelabels.csv")))
imageids = []
...
bboxs = (pd.read_csv("./data/oidv6-train-annotations-bbox.csv").append(
    pd.read_csv("./data/test-annotations-bbox.csv")).append(
        pd.read_csv("./data/validation-annotations-bbox.csv")))
print(len(bboxs))
...
image_urls = (pd.read_csv(
    "./data/oidv6-train-images-with-labels-with-rotation.csv").append(
        pd.read_csv("./data/validation-images-with-rotation.csv")).append(
            pd.read_csv("./data/test-images-with-rotation.csv")).append(
                pd.read_csv("./data/train-images-boxable-with-rotation.csv")))
    ...
    if imgid[0] in imgids:
        ...
        for idx_3 in range(len(imgid_of_iabaid)):
            imgid_of_iabaid_iter = images_and_bbox_and_imgid_[
                images_and_bbox_and_imgid_["ImageID"] == imgid[0]].iloc[idx_3]
...
data.to_csv(f"./data/Cleaned-Data-{str(random.randint(0,100000))}.csv",
            index=False)
