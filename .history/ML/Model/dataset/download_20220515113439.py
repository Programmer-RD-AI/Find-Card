...
class Download:
    ...
    def __init__(
        ...
        if labels is None:
            labels = ["/m/01h44", "/m/01m0p1", "/m/02hhhb", "/m/0449p", "/m/0464z4","/m/04lmyz"]
        if labels_r is None:
            labels_r = [
                "/m/0r3vbqy",
                "/m/025rxrz",
        ...
        if labels_and_imageids is None:
            labels_and_imageids = [
                ...
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/train-annotations-human-imagelabels-boxable.csv",
                ...
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/test-annotations-machine-imagelabels.csv",
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/test-annotations-human-imagelabels-boxable.csv",
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/validation-annotations-human-imagelabels-boxable.csv",
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/validation-annotations-machine-imagelabels.csv",
            ]
        if bboxs is None:
            bboxs = [
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/oidv6-train-annotations-bbox.csv",
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/test-annotations-bbox.csv",
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/validation-annotations-bbox.csv",
            ]
        if image_urls is None:
            image_urls = [
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/oidv6-train-images-with-labels-with-rotation.csv",
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/test-images-with-rotation.csv",
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/train-images-boxable-with-rotation.csv",
                "/media/indika/Sync/Programmer-RD-AI/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/ML/Model/dataset/open_image_raw_data/validation-images-with-rotation.csv",
            ]
        ...
        try:
            ...
            raise ValueError(f"Recovering Error: {e}")
        try:
            # Indexing
            self.idx = idx
            self.idx_1 = idx_1
    ...
    def download(self) -> bool:
        ...
        try:
            ...
            print("Intializing Downloading Proccess")
            self.create_imageids()
            self.create_bbox()
            self.create_image_urls()
            self.download_images()
