...
class Download:
    ...
    def __init__(
        ...
        if labels_and_imageids is None:
            labels_and_imageids = [
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/oidv6-train-annotations-human-imagelabels.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/test-annotations-human-imagelabels-boxable.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/test-annotations-machine-imagelabels.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/train-annotations-human-imagelabels-boxable.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/train-annotations-machine-imagelabels.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/validation-annotations-human-imagelabels-boxable.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/validation-annotations-machine-imagelabels.csv",
            ]
        if bboxs is None:
            bboxs = [
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/oidv6-train-annotations-bbox.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/test-annotations-bbox.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/validation-annotations-bbox.csv",
            ]
        if image_urls is None:
            image_urls = [
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/oidv6-train-images-with-labels-with-rotation.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/test-images-with-rotation.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/train-images-boxable-with-rotation.csv",
                "/media/indika/Sync/Programming/Projects/Python/Rest-Api/Car-Object-Detection-REST-API/Find-Card/Model/open_image_raw_data/validation-images-with-rotation.csv",
            ]
    ...
    def create_bbox(self) -> bool:
        ...
        try:
            ...
            self.images_and_bbox_and_imgid_.to_csv("./create_bbox.csv", index=False)
